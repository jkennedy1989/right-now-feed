...
export const weeklyPicks: WeeklyPick[] = [
  ...
  { id: "rom-pick", name: "Royal Ontario Museum", rating: 4.7, description: "Dramatic, sharp glass shards hit heritage", imageUrl: "https://libeskind.com/wp-content/uploads/the-rom-lights-up-bloor-street-c-royal-ontario-museum-2280x1900.jpg", videoUrl: "https://stream.mux.com/yd9w9hYBACKnOyCapjGVBoZOYeRI0002LlH014QxEQPO8w/high.mp4", tags: ["Cultural🎭", "Iconic🏛️"] },
  ...
  { id: "monkeys-paw-pick", name: "The Monkey's Paw", rating: 4.8, description: "Novelty book vending machine dispenses random vintage reads.", imageUrl: "https://worldliteraturetoday.org/sites/default/files/2020/winter/outpost-monkeyspaw-tylermcelroy.jpg", tags: ["Hidden Gem💎", "Quirky🎪"] },
];
